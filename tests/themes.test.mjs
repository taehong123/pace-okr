...
const css = (await Promise.all(["../app/globals.css", "../app/workspace-design.css", "../app/project-review/review.css"].map((path) => readFile(new URL(path, import.meta.url), "utf8")))).join("\n");
const luminance = (hex) => {
