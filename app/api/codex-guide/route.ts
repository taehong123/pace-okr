const guide = {
  ...
  endpoints: [
    ...
    { purpose: "List or search items", method: "GET", path: "/api/items?kind=&status=&cadence=&parentId=&q=" },
    { purpose: "Create an item", method: "POST", path: "/api/items", body: "title required; optional description, kind, cycleId, parentId, routineId, status, priority, cadence, progress, dueDate; use source=codex" },
    ...
    { purpose: "Read custom properties and values", method: "GET", path: "/api/properties" },
    { purpose: "Set one custom property value", method: "PUT", path: "/api/property-values", body: "itemId, propertyId, value" },
