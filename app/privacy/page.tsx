...
export default function PrivacyPage() {
  return <main className="legal-page"><article>
    ...
    <section><h2>6. 보호 조치</h2><p>OAuth 토큰과 Payple 빌링키는 서로 분리된 전용 키로 암호화하고, 접근 권한을 서비스 제공에 필요한 범위로 제한합니다. 결제자 중복 확인에는 원문 대신 단방향 해시를 사용합니다. 카드 전체 번호, CVC, Payple 원본 응답과 전화번호는 OKRPTR 데이터베이스에 저장하지 않습니다.</p></section>
