...
const endpoint = process.env.OKRI_MCP_URL || process.env.OKITA_MCP_URL || process.env.PACE_MCP_URL || "http://localhost:3002/api/mcp";
const client = new Client({ name: "okri-smoke", version: "0.6.0" });
